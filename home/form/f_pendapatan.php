...
<script>
	...
	$(document).ready(function(){
			$("#rekening").autocomplete({
				minLength:2,
				source:'autoc/cari_rek.php?cari=pendapatan',
...
<div style="margin-top:-50;">
					<h2 ><center><strong>FORM TRANSAKSI PENDAPATAN</strong></center></h2>
...
<table width="90%" cellpadding="2%" style="border:0px;" align="center" >
	...
	<tr>
		<td colspan="3" height="30" valign="bottom" style="border:0px;"><strong> Input Rincian pendapatan : </strong></td>
	</tr>
	<tr>
	...
	<tr>
		...
		<td style="border:0px;"> 
		<br>
			<input type='button' onclick="val_pendapatan('<?php echo $edit_id; ?>')" name='simpan' id='simpan' value=' Simpan '/>  
			<input type='Reset' name='reset' value=' Reset ' onClick='deleteAllRows()' /> 
			<input type='button' name='back' value=' Kembali ' onClick="tampil('ttranspendapatan','','','')" /> 
		</td>
	</tr>
</table>
</form>	
