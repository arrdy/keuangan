<table border=1 width="98%" align="center" style="border:0px;">
                                    <thead>
                                        <tr class="head" >
                                            ...
                                            <th width="25%" style="text-align : center;">Nama Rek</th>
											<th width="18%" style="text-align : center;">Ket Dana</th>
...
<form name='lpengadaan' method="post" action='view_lap/print_jurnal.php?t1=<?php echo $tgl1 ?>&t2=<?php echo $tgl2; ?>&not=<?php echo $not; ?>&nama=<?php echo $inv; ?>' target='_blank'>
