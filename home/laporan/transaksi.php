...
<script type="text/javascript">		
	function filter_transaksi(){  // UNTUK CONTENT
		var t1 = document.getElementById('t1').value;
		var t2 = document.getElementById('t2').value;
		var not = document.getElementById('not').value;
		var tarik_file = "view_lap/v_transaksi.php?t1="+t1+"&t2="+t2+"&not="+not; 
		$('#viewlap').load(tarik_file);
	}
</script>
<h2 style="margin-left:50;"> LAPORAN TRANSAKSI </h2>  
...
Investasi :
	...
	<input class="btn btn-outline btn-success" type='button' onclick="filter_transaksi();" value='Preview' class='button'>
</form>
</div>
