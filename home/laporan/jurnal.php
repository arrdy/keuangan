...
<script type="text/javascript">
	...
	function filter_jurnal(){  // UNTUK CONTENT
		var t1 = document.getElementById('t1').value;
		var t2 = document.getElementById('t2').value;
		var not = document.getElementById('not').value;
		var tarik_file = "view_lap/v_jurnal.php?t1="+t1+"&t2="+t2+"&not="+not; 
		$('#viewlap').load(tarik_file);
	}
</script>
<h2 style="margin-left:50;"> LAPORAN JURNAL </h2> 
...
Investasi :
	...
	<input class="btn btn-outline btn-success" type='button' onclick="filter_jurnal();" value='Preview' class='button'>
</form>
</div>
